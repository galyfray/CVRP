...
export function ResultPage() {
    ...
    const [method_str, setMethod_str] = React.useState("");
                    ...
                    >
                        <Grid container alignItems="center" spacing={2}>
                            ...
                            <Grid item alignItems="center" xs={12}>
                                <Button variant="contained" sx={{ height: 20, width:260, ml:2.5 }} href="/logs" >
                                    Plus de détails
                                </Button>
                            </Grid>
                            <Grid item alignItems="center" xs={12}>
                                <Button variant="contained"
                                sx={{ height: 20, width:260, backgroundColor:"#434343", ml:2.5 }} href="/" >
